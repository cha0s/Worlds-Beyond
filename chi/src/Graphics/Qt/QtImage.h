#ifndef CHI_QTIMAGE_H
#define CHI_QTIMAGE_H
...
public:
	 ...
	 */
	void render(int x, int y, Image &destination, int alpha = 255, DrawMode mode = DrawMode_Blend, int sx = 0, int sy = 0, int sw = 0, int sh = 0) const CHI_ENSURE_STACK_ALIGNED_FOR_SSE;
